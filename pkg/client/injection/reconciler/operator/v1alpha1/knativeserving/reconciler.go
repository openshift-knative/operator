...
type reconcilerImpl struct {
	...
	Lister operatorv1alpha1.KnativeServingLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister operatorv1alpha1.KnativeServingLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
